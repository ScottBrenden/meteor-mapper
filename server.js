...
const nasaURL = `https://data.nasa.gov/resource/y77d-th95.json?$$app_token=${NASA_TOKEN}&$limit=10000`;
...
//const conString = 'postgres://postgres:1234@localhost:5432/meteors';
const conString = DATABASE_URL || 'postgres://postgres:hofbrau@localhost:5432/meteors';
